   ...
   <!--==========================
    ...
    <div class="card" style="width: 100%; ">
         <div class="container">
                ...
                <div class="row mb-2">
                        <div class="col-md-6">
                            <label>Period in Current Employment/Business</label>
                            <asp:TextBox ID="txt3CurrentEmploymentYear" class="form-control" PlaceHolder="Year" runat="server"></asp:TextBox>
                            <asp:TextBox ID="txt3CurrentEmploymentMonth" class="form-control" PlaceHolder="Month" runat="server"></asp:TextBox>
                        </div>
                        <div class="col-md-6">
                            <label>Total Employment/Business Period</label>
                            <asp:TextBox ID="txt3TotalEmploymentYear" class="form-control" PlaceHolder="Year" runat="server"></asp:TextBox>
                            <asp:TextBox ID="txt3TotalEmploymentMonth" class="form-control" PlaceHolder="Month" runat="server"></asp:TextBox>
                        </div>
                </div><br />
                ...
                <div class="row mb-2">
                        ...
                        <div class="col-md-4">
                            ...
                            <asp:TextBox ID="txt3PinCode" class="form-control" runat="server"></asp:TextBox>
                        </div>
                </div><br />
                ...
                <div class="row mb-2">
                        ...
                        <div class="col-md-4">
                            ...
                            <asp:TextBox ID="txt3Phone" class="form-control" runat="server"></asp:TextBox>
                        </div>
                        <div class="col-md-4">
         ...
         <div class="container">
                ...
                <div class="row mb-2">
                        <div class="col-md-4">
                            ...
                            <asp:TextBox ID="txt4GrossIncome" class="form-control" runat="server"></asp:TextBox>
                        </div>
                        <div class="col-md-4">
                            ...
                            <asp:TextBox ID="txt4netIncome" class="form-control" runat="server"></asp:TextBox>
                        </div>
                        <div class="col-md-4">
                            ...
                            <asp:TextBox ID="txt4OtherIncome" class="form-control" runat="server"></asp:TextBox>
                        </div>
                </div><br />
                ...
                <div class="row mb-2">
                        <div class="col-md-4">
                            ...
                            <asp:TextBox ID="txt4TotalIncome" class="form-control" runat="server"></asp:TextBox>
                        </div>
               </div><br />
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txt4AccountNo1" class="form-control" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txt4AccountNo2" class="form-control" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                <div class="row mb-2">
                        <div class="col-md-4">
                            ...
                            <asp:TextBox ID="txt4Deposits" class="form-control" runat="server"></asp:TextBox>
                        </div>
                        <div class="col-md-4">
                            <label>Insurance</label>
                            <asp:TextBox ID="txt4Insurance" class="form-control" runat="server"></asp:TextBox>
                        </div>
                        <div class="col-md-4">
                            <label>Shares</label>
                            <asp:TextBox ID="txt4Shares" class="form-control" runat="server"></asp:TextBox>
                        </div>
                </div><br />
                ...
                <div class="row mb-2">
                        <div class="col-md-4">
                            ...
                            <asp:TextBox ID="txt4MutualFunds" class="form-control" runat="server"></asp:TextBox>
                        </div>
                        <div class="col-md-4">
                            <label>Other Investment</label>
                            <asp:TextBox ID="txt4Others" class="form-control" runat="server"></asp:TextBox>
                        </div>
                        <div class="col-md-4">
                            <label>Total Investment</label>
                            <asp:TextBox ID="txt4TotalInvestment" class="form-control" runat="server"></asp:TextBox>
                        </div>
                </div>
         </div><br />
     </div>
         ...
         <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <asp:DropDownList ID="ddl5LoanRequired" runat="server" class="form-control">
                                <asp:ListItem>Choose...</asp:ListItem>
                    ...
                    <div class="col-md-4">
                        ...
                        <asp:TextBox ID="txt5LoanAmount" class="form-control" runat="server"></asp:TextBox>
                    </div>
                    <div class="col-md-4">
                        ...
                        <asp:TextBox ID="txt5Terms" class="form-control" runat="server"></asp:TextBox>
                    </div>
                </div><br />
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <asp:DropDownList ID="ddl5LoanPurpose" runat="server" class="form-control">
                                <asp:ListItem>Choose...</asp:ListItem>
                                <asp:ListItem>Puurchase Home</asp:ListItem>
         ...
         <div class="container">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Property Classification New</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txt6MarketValue2" class="form-control" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Building Name</td>
                                        ...
                                        <td>Registered Value/Agreement Value(Rs.)</td>
                                        <td>
                                            <asp:TextBox ID="txt6RegisteredValue2" class="form-control" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Area of Property/Land(In Sq. Ft.)</td>
                                        <td>
                                            <asp:TextBox ID="txt6Area1" class="form-control" runat="server"></asp:TextBox>
                                        </td>
                                        <td>Area of Property/Land(In Sq. Ft.)</td>
                                        <td>
                                            <asp:TextBox ID="txt6Area2" class="form-control" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Cost of Property / Land(Rs.)</td>
                                        <td>
                                            <asp:TextBox ID="txt6PropertyCost1" class="form-control" runat="server"></asp:TextBox>
                                        </td>
                                        <td>Build-up Area(In Sq. Ft.)</td>
                                        <td>
                                            <asp:TextBox ID="txt6BuildArea2" class="form-control" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Pin</td>
                                        <td>
                                            <asp:TextBox ID="txt6Pin1" class="form-control" runat="server"></asp:TextBox>
                                        </td>
                                        <td>Pin</td>
                                        <td>
                                            <asp:TextBox ID="txt6Pin2" class="form-control" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>City</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>For Applications Under Reverse Mortgage Scheme</td>
                                        <td>
                                            <asp:DropDownList ID="ddl6ApplicationFor1" runat="server" class="form-control">
                                               <asp:ListItem>Choose...</asp:ListItem>
                                    ...
                                    <tr>
                                        ...
                                        <td>In case of Lumpsum plan, please specify the lumpsum Amount(Rs.)</td>
                                        <td>
                                            <asp:TextBox ID="txt6LumpsumPlan2" class="form-control" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Address of Selle</td>
                                        <td>
                                            <asp:TextBox ID="txt6SellerAddress1" class="form-control" runat="server"></asp:TextBox>
                                        </td>
                                        <td>In case of Annuity, please specify the periodicity of Annuity</td>
                                        <td>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <asp:TextBox ID="txt6PurchaseCost" class="form-control" runat="server"></asp:TextBox>
                    </div>
                    <div class="col-md-4">
                        <asp:Label ID="Label22" runat="server" Text="Registration Cost(Rs.)"></asp:Label>
                        <asp:TextBox ID="txt6RegistratonCost" class="form-control" runat="server"></asp:TextBox>
                    </div>
                </div><br />
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <asp:TextBox ID="txt6TotalCost" class="form-control" runat="server"></asp:TextBox>
                    </div>
                    <div class="col-md-3">
                        <asp:Label ID="Label26" runat="server" Text="Stamp Duty Cost(Rs.)"></asp:Label>
                        <asp:TextBox ID="txt6StampCost" class="form-control" runat="server"></asp:TextBox>
                    </div>
                    <div class="col-md-3">
                        <asp:Label ID="Label24" runat="server" Text="Other Cost(Rs.)"></asp:Label>
                        <asp:TextBox ID="txt6OtherCost" class="form-control" runat="server"></asp:TextBox>
                    </div>
                    <div class="col-md-3">
                        <asp:Label ID="Label25" runat="server" Text="Own Contribution(Rs.)"></asp:Label>
                        <asp:TextBox ID="txt6OwnContribution" class="form-control" runat="server"></asp:TextBox>
                    </div>
                </div>
                ...
                <div class="row mb-2">
                        <div class="col-md-12">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                   <tr>
                                        <td>Name<asp:RequiredFieldValidator ID="RequiredFieldValidator71" runat="server" ErrorMessage="(Invalid Data)" ControlToValidate="txt8Name1" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>Relation<asp:RequiredFieldValidator ID="RequiredFieldValidator72" runat="server" ErrorMessage="(Invalid Data)" ControlToValidate="txt8Relation1" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>Address<asp:RequiredFieldValidator ID="RequiredFieldValidator73" runat="server" ErrorMessage="(Invalid Data)" ControlToValidate="txt8Address1" ForeColor="Red"></asp:RequiredFieldValidator></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>City<asp:RequiredFieldValidator ID="RequiredFieldValidator74" runat="server" ErrorMessage="(Invalid Data)" ControlToValidate="txt8Address1" ForeColor="Red"></asp:RequiredFieldValidator></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>State<asp:RequiredFieldValidator ID="RequiredFieldValidator75" runat="server" ErrorMessage="(Invalid Data)" ControlToValidate="txt8Address1" ForeColor="Red"></asp:RequiredFieldValidator></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>Country<asp:RequiredFieldValidator ID="RequiredFieldValidator76" runat="server" ErrorMessage="(Invalid Data)" ControlToValidate="txt8Address1" ForeColor="Red"></asp:RequiredFieldValidator></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>PIN Code<asp:RequiredFieldValidator ID="RequiredFieldValidator77" runat="server" ErrorMessage="(Invalid Data)" ControlToValidate="txt8Pin1" ForeColor="Red"></asp:RequiredFieldValidator></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>Mobile<asp:RequiredFieldValidator ID="RequiredFieldValidator78" runat="server" ErrorMessage="(Invalid Data)" ControlToValidate="txt8Mobile1" ForeColor="Red"></asp:RequiredFieldValidator></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>E-Mail<asp:RequiredFieldValidator ID="RequiredFieldValidator79" runat="server" ErrorMessage="(Invalid Data)" ControlToValidate="txt8Email1" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator></td>
                                        <td>
         ...
         <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <img id="output_image" class="auto-style1" border="10" /><br />
                    ...
                    <div class="col-md-4">
                        ...
                        <img id="output_sign" class="auto-style3" border="10" /><br />
