                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                   <tr>
                                    ...
                                    <tr>
                                        <td>City<asp:RequiredFieldValidator ID="RequiredFieldValidator74" runat="server" ErrorMessage="(Invalid Data)" ControlToValidate="txt7City2" ForeColor="Red"></asp:RequiredFieldValidator></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>Country<asp:RequiredFieldValidator ID="RequiredFieldValidator76" runat="server" ErrorMessage="(Invalid Data)" ControlToValidate="txt7Country2" ForeColor="Red"></asp:RequiredFieldValidator></td>
                                        <td>
